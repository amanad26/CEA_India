...
public class AddCustomerModel {
    ...
    public class Datum {
        ...
        @Expose
        private Object customerAnniverseryDate;
        @SerializedName("customer_whatspp_no")
        @Expose
        private Object customerWhatsppNo;
        @SerializedName("customer_profile_img")
        @Expose
        private Object customerProfileImg;
        ...
        public Object getCustomerAnniverseryDate() {
            return customerAnniverseryDate;
        }

        public void setCustomerAnniverseryDate(Object customerAnniverseryDate) {
            this.customerAnniverseryDate = customerAnniverseryDate;
        }

        public Object getCustomerWhatsppNo() {
            return customerWhatsppNo;
        }

        public void setCustomerWhatsppNo(Object customerWhatsppNo) {
            this.customerWhatsppNo = customerWhatsppNo;
        }

        public Object getCustomerProfileImg() {
            return customerProfileImg;
        }

        public void setCustomerProfileImg(Object customerProfileImg) {
